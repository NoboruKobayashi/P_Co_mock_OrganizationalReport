...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("JobHeaderViewsListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheJobHeaderViewsListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheJobHeaderViewsListGenerated.onFilterBar().iChangeSearchField("Search Term");
